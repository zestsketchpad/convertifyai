...
export default function AuthModal({ open, onClose, onSuccess }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-200 flex items-center justify-center px-4 py-8">
      ...
      <button aria-label="Close login dialog" className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={onClose} />

      <div className="relative z-210 w-full max-w-md rounded-2xl backdrop-blur-xl" style={{ background: "var(--white)", border: "1px solid var(--border)", boxShadow: "var(--shadow-lg)" }}>
        <div className="p-8 sm:p-10">
          <div className="mb-8 text-center sm:text-left">
            <h2 className="text-4xl font-bold mb-2" style={{ color: "var(--text)", fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700 }}>
              Welcome back
            </h2>
          ...
          <form onSubmit={signInWithPassword} className="space-y-5">
            <div>
              <label htmlFor="auth-email" className="block text-sm font-semibold mb-2" style={{ color: "var(--text)", fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                Email address
              </label>
              <input
                id="auth-email"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="auth-password" className="text-sm font-semibold" style={{ color: "var(--text)", fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                  Password
                </label>
